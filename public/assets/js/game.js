...
function sys(cmd){//sys 用來幫助該句子的表達
	...
	cmding=true;
			...
			if(para[1]=="bg"){
			    ...
			    $("#bgimg").fadeOut(0,function(){
			        $(this).fadeIn(2000,function(){
			            document.getElementById("temp_bgimg").src = "assets/transparent.png";})});
			    $("#bgimg").css({'scale':'150%',
		...
		if(ncmd=="effectlayer" ){
            ...
            if(para[1]=="off"){
                effectlayer("assets/transparent.png");
                effectlayer2("assets/transparent.png");
                effectlayer3("assets/transparent.png");
            }else{
                var elayer="1";
